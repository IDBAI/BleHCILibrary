...
//     * 准备断开连接
//     */
//    public static final String ACTION_HCI_READY_DISCONNECT = "com.revenco.blehcilibrary.command.ACTION_HCI_READY_DISCONNECT";
//    /**
//     * 证书开门校验结果通知事件
//     */
...
////                break;
//            case ACTION_HCI_READY_DISCONNECT:
//                removeAppConnectTimer();
//                XLog.d(TAG, "准备断开连接");
...
//                }
//                break;
//            case ACTION_GATT_UPDATE_CHAR_VAL_SUCCESS://8 gatt update char val ---> notify 成功
////                //TODO 重启广播
